...
public interface IRoom
{
    ...
    /// <summary>
    /// Gets the Password of this room.
    /// </summary>
    string Model { get; }
    ...
    /// </summary>
    TAvatar? GetAvatarById<TAvatar>(int id) where TAvatar : IAvatar;

    bool TryGetAvatarByIndex<TAvatar>(int index, [NotNullWhen(true)] out TAvatar? avatar) where TAvatar : IAvatar;
    bool TryGetAvatarById<TAvatar>(int id, [NotNullWhen(true)] out TAvatar? avatar) where TAvatar : IAvatar;
    ...
    bool TryGetUserById(int id, [NotNullWhen(true)] out IUser? user) => TryGetAvatarById(id, out user);
    ...
    bool TryGetPetById(int id, [NotNullWhen(true)] out IPet? pet) => TryGetAvatarById(id, out pet);
    ...
    bool TryGetBotById(int id, [NotNullWhen(true)] out IBot? bot) => TryGetAvatarById(id, out bot);
