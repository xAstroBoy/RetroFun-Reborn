...
{
    static ClientType IMessage<InventoryItemAddedOrUpdatedMsg>.SupportedClients => ClientType.Nitro;
    static Identifier IMessage<InventoryItemAddedOrUpdatedMsg>.Identifier => In.User_Furniture_Add;
