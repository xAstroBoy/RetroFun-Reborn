...
public sealed class NotificationDialogMsg(string type) : Dictionary<string, string>, IMessage<NotificationDialogMsg>
{
    ...
    static ClientType IMessage<NotificationDialogMsg>.SupportedClients => ClientType.Nitro;
    static Identifier IMessage<NotificationDialogMsg>.Identifier => In.Notification_Dialog;
