...
public abstract record AvatarChatMsgBase(ChatType Type)
{
        ...
        : this(type)
    {
        if (Type == (ChatType)(-1))
        {
            ...
            if (p.Header.Value == In.Chat.HeaderID.GetValueOrDefault())
                Type = ChatType.Talk;
            else if(p.Header.Value == In.Shout.HeaderID.GetValueOrDefault())
                Type = ChatType.Shout;
            else if(p.Header.Value == In.Whisper.HeaderID.GetValueOrDefault())
...
/// <item>Shockwave: <see cref="In.CHAT"/></item>
/// </list>
/// </summary>
...
/// <item>Shockwave: <see cref="In.CHAT_3"/></item>
/// </list>
/// </summary>
...
/// <item>Shockwave: <see cref="In.CHAT_2"/></item>
/// </list>
/// </summary>
