...
{
    static ClientType IMessage<AvatarHandItemMsg>.SupportedClients => ClientType.Nitro;
    static Identifier IMessage<AvatarHandItemMsg>.Identifier => In.Hand_Item_Received;
