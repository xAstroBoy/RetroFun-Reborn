...
{
    static ClientType IMessage<GetProfileByNameMsg>.SupportedClients => ClientType.Nitro;
    static Identifier IMessage<GetProfileByNameMsg>.Identifier => Out.User_Profile_By_Name;
