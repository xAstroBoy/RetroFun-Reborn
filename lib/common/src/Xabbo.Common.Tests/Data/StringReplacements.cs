...
public class StringReplacements : IEnumerable<object[]>
{
    public IEnumerator<object[]> GetEnumerator()
    {
        ...
        yield return new object[] { "this is a very int string", "hi" };
        yield return new object[] { "hi", "this is a very int string" };
        // Note: fails on outgoing Shockwave if the string length is > 4095, the maximum value of a B64
        yield return new object[] { $"this is a ver{new string('y', 4000)} int string", string.Empty };
        yield return new object[] { string.Empty, $"this is a ver{new string('y', 4000)} int string" };
